...
class Qwen2_5_VL_3B_VLA(Qwen2_5_VLForConditionalGeneration):
    ...
    def transform_input(self, processor: AutoProcessor, messages: List, action_mask_ratio: float = 0.0):
        '''
        Args:
        ...
        if action_mask_ratio > 0.0:
            ...
            messages_masked = self.mask_actions(messages_masked, action_mask_ratio, is_batch=is_batch)
    ...
    def mask_actions(self, messages: List, mask_ratio: float, is_batch: bool = False) -> List:
        """        
        Returns:
            character-level masked messages
        """
